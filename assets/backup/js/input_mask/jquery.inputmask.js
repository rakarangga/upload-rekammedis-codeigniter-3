! function(e) {
    ...
    function n(t) {
        function i(i) {
            ...
            for (var o, r, s, l, u, c, d = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})\??|[^.?*+^${[]()|\\]+|./g, p = !1, v = new a, f = [], m = []; o = d.exec(i);) switch (r = o[0], r.charAt(0)) {
                case t.optionalmarker.end:
                case t.groupmarker.end:
                    if (s = f.pop(), f.length > 0) {
                        if (l = f[f.length - 1], l.matches.push(s), l.isAlternator) {
                            u = f.pop();
                            for (var h = 0; h < u.matches.length; h++) u.matches[h].isGroup = !1;
                ...
                case t.quantifiermarker.start:
                    ...
                    r = r.replace(/[{}]/g, "");
                    var g = r.split(","),
                        b = isNaN(g[0]) ? g[0] : parseInt(g[0]),
                        y = 1 == g.length ? b : isNaN(g[1]) ? g[1] : parseInt(g[1]);
                    if (("*" == y || "+" == y) && (b = "*" == y ? 0 : 1), k.quantifier = {
                            min: b,
                            max: y
                        }, f.length > 0) {
        ...
        function a(a, n) {
            ...
            return void 0 == e.inputmask.masksCache[a] && (e.inputmask.masksCache[a] = {
                mask: a,
                maskToken: i(a),
                validPositions: {},
                _buffer: void 0,
                ...
                tests: {},
                metadata: n
            }), e.extend(!0, {}, e.inputmask.masksCache[a])
        }

        function n(e) {
            if (e = e.toString(), t.numericInput) {
                e = e.split("").reverse();
                for (var i = 0; i < e.length; i++) e[i] == t.optionalmarker.start ? e[i] = t.optionalmarker.end : e[i] == t.optionalmarker.end ? e[i] = t.optionalmarker.start : e[i] == t.groupmarker.start ? e[i] = t.groupmarker.end : e[i] == t.groupmarker.end && (e[i] = t.groupmarker.start);
                e = e.join("")
            }
            return e
        }
    ...
    function o(a, n, o) {
        function r(e, t, i) {
            ...
            do {
                ...
                } else o = m(s, a, s - 1), n = o.match, a = o.locator.slice(), r.push(j(s, n));
                s++
        ...
        function v(t, i, a) {
            if (o.insertMode && void 0 != c().validPositions[t] && void 0 == a) {
                var n, r = e.extend(!0, {}, c().validPositions),
                    s = p();
                for (n = t; s >= n; n++) delete c().validPositions[n];
                ...
                if (!u) return c().validPositions = e.extend(!0, {}, r), !1
        ...
        function f(e, t, i, a) {
            ...
            for (n = r; t > n; n++) void 0 != c().validPositions[n] && (i === !0 || 0 != o.canClearPosition(c(), n, p(), a, o)) && delete c().validPositions[n];
            for (d(!0), n = r + 1; n <= p();) {
                for (; void 0 != c().validPositions[r];) r++;
        ...
        function g(t, i, a) {
            function n(i, a, o, s) {
                function d(o, s, v) {
                    if (r > 1e4) return alert("jquery.inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + c().mask), !0;
                    if (r == t && void 0 == o.matches) return l.push({
                        match: o,
                        locator: s.reverse()
                    }), !0;
                    if (void 0 != o.matches) {
                        if (o.isGroup && v !== !0) {
                            if (o = d(i.matches[p + 1], s)) return !0
                        } else if (o.isOptional) {
                            var f = o;
                            if (o = n(o, a, s, v)) {
                                var m = l[l.length - 1].match,
                                    h = 0 == e.inArray(m, f.matches);
                                h && (u = !0), r = t
                            }
                            ...
                            if (-1 == P || "string" == typeof P) {
                                ...
                                "string" == typeof P && (b = e.map(b, function(t, i) {
                                    if (isFinite(i)) {
                                        ...
                                        for (var o = 0; o < n.length; o++) a = -1 != e.inArray(n[o], E), a && (void 0 != t.locator[_] ? (t.locator[_] += ",", t.alternation = _, t.locator[_] += n[o]) : t.locator[_] = parseInt(n[o]));
                                        if (void 0 != t.locator[_]) return t
                                    }
                                })), l = y.concat(b), u = !0
            ...
            var o = c().maskToken,
                ...
                u = !1;
            if (void 0 == i) {
                for (var d, p = t - 1; void 0 == (d = c().validPositions[p]) && p > -1;) p--;
                if (void 0 != d && p > -1) r = p, s = d.locator.slice();
                else {
                    for (p = t - 1; void 0 == (d = c().tests[p]) && p > -1;) p--;
            ...
            return (0 == l.length || u) && l.push({
                ...
                locator: []
            }), c().tests[t] = e.extend(!0, [], l), c().tests[t]
        }
        ...
        function _(e, t, i) {
            if (i = i || y().slice(), e === !0) d(), e = 0, t = i.length;
                ...
                for (var a = e; t > a; a++) delete c().validPositions[a], delete c().tests[a];
        ...
        function C(t, i, a, n) {
            function r(t, i, a, n) {
                ...
                return e.each(g(t), function(s, l) {
                    for (var u = l.match, m = i ? 1 : 0, h = "", k = (y(), u.cardinality); k > m; k--) h += S(t - (k - 1));
                    if (i && (h += i), r = null != u.fn ? u.fn.test(h, c(), t, a, o) : i != u.def && i != o.skipOptionalPartCharacter || "" == u.def ? !1 : {
                            c: u.def,
                            pos: t
                        }, r !== !1) {
                        ...
                        if (void 0 != r.remove && f(r.remove, r.remove + 1, !0), r.refreshFromBuffer) {
                            ...
                            if (a = !0, _(E === !0 ? E : E.start, E.end), void 0 == r.pos && void 0 == r.c) return r.pos = p(), !1;
                            if (b = void 0 != r.pos ? r.pos : t, b != t) return r = e.extend(r, C(b, g, !0)), !1
                        } else if (r !== !0 && void 0 != r.pos && r.pos != t && (b = r.pos, _(t, b), b != t)) return r = e.extend(r, C(b, g, !0)), !1;
                        return 1 != r && void 0 == r.pos && void 0 == r.c ? !1 : (s > 0 && d(!0), v(b, e.extend({}, l, {
                            input: P(g, u)
                        }), n) || (r = !1), !1)
                    }
                }), r
                        ...
                        if (parseInt(u) > parseInt(r) && void 0 === c().validPositions[u].alternation) {
                            for (var v = c().validPositions[u], f = v.locator[s], m = c().validPositions[r].locator[s].split(","), h = 0; h < m.length; h++)
                                if (f < m[h]) {
                                    ...
                                    if (f != k.locator[s]) {
                                        for (var _ = y().slice(), P = u; P < p() + 1; P++) delete c().validPositions[P], delete c().tests[P];
                                        d(!0), o.keepStatic = !o.keepStatic;
                                        for (var P = u; P < _.length; P++) _[P] != o.skipOptionalPartCharacter && C(p() + 1, _[P], !1, !0);
                                        k.locator[s] = g;
                                        var E = C(t, i, a, n);
                                        if (o.keepStatic = !o.keepStatic, E) return E;
                ...
                for (var a = c().validPositions[i], n = a.locator, o = n.length, r = t; i > r; r++)
                    if (!x(r)) {
                        ...
                        e.each(s, function(e, t) {
                            for (var i = 0; o > i; i++) t.locator[i] && E(t.locator[i].toString().split(","), n[i].toString().split(",")) && i > u && (u = i, l = t)
                        }), v(r, e.extend({}, l, {
                            input: l.match.def
                        }), !0)
                    }
            ...
            for (m++; t > m; m++) void 0 == c().validPositions[m] && ((!x(m) || u[m] != j(m)) && g(m).length > 1 || u[m] == o.radixPoint || "0" == u[m] && e.inArray(o.radixPoint, u) < m) && r(m, u[m], !0);
            var h = t,
                k = !1,
                b = e.extend(!0, {}, c().validPositions);
            ...
            if (k === !1 && o.keepStatic && R(u) && (k = s(t, i, a, n)), k === !0 && (k = {
                    pos: h
                }), e.isFunction(o.postValidation) && 0 != k && !a) {
                d(!0);
                var G = o.postValidation(y(), o);
                if (!G) return d(!0), c().validPositions = e.extend(!0, {}, b), !1
            }
            return k
        }
        ...
        function M() {
            ...
            var t, i = p(),
                a = c().validPositions[i],
                n = void 0 != a ? a.locator.slice() : void 0;
            for (t = i + 1; void 0 == a || null != a.match.fn || null == a.match.fn && "" != a.match.def; t++) a = m(t, n, t - 1), n = a.locator.slice();
        ...
        function T(t, i, a, n) {
            function o() {
                var e = !1,
                    t = b().slice(v, A(v)).join("").indexOf(u);
                if (-1 != t && !x(v)) {
                    e = !0;
            ...
            var s = b().slice(0, A(-1)).join(""),
                l = r.join("").match(new RegExp(G(s), "g"));
        ...
        function B(t, i, a) {
            ...
            if ("number" != typeof i) return r.setSelectionRange ? (i = r.selectionStart, a = r.selectionEnd) : document.selection && document.selection.createRange && (n = document.selection.createRange(), i = 0 - n.duplicate().moveStart("character", -1e5), a = i + n.text.length), {
                begin: F(i),
                end: F(a)
            };
        ...
        function I(t) {
            ...
            for (i = r + 1; i < n.length; i++) a = m(i, u, i - 1), u = a.locator.slice(), s[i] = e.extend(!0, {}, a);
            var d = l && void 0 != l.alternation ? l.locator[l.alternation].split(",") : [];
            for (i = o - 1; i > r && (a = s[i].match, (a.optionality || a.optionalQuantifier || l && void 0 != l.alternation && void 0 != s[i].locator[l.alternation] && -1 != e.inArray(s[i].locator[l.alternation].toString(), d)) && n[i] == j(i, a)); i--) o--;
            return t ? {
                l: o,
        ...
        function R(t) {
            if (e.isFunction(o.isComplete)) return o.isComplete.call(it, t, o);
                            ...
                            if (!this.disabled && (!this.readOnly || "keydown" == e.type && e.ctrlKey && 67 == e.keyCode)) {
                                switch (e.type) {
                                    ...
                                    case "keydown":
                                        ...
                                        break;
                                    case "keypress":
                                        if (ot === !0) return e.preventDefault();
                                        ot = !0;
                                        break;
        ...
        function H(t) {
                    ...
                    e.valHooks[t] = {
                        get: function(t) {
                            ...
                            if (a.data("_inputmask")) {
                                if (a.data("_inputmask").opts.autoUnmask) return a.inputmask("unmaskedvalue");
                                var n = i(t),
                                    o = a.data("_inputmask"),
                                    r = o.maskset,
                                    s = r._buffer;
            ...
            function r(t) {
                ...
                var i = e._data(t).events,
                    a = i.mouseover;
                if (a) {
                    for (var n = a[a.length - 1], r = a.length - 1; r > 0; r--) a[r] = a[r - 1];
                    a[0] = n
                }
            }
            var s, l;
        ...
        function q(t, i, a, n, r) {
            ...
            if (!(i === !0 || t.ctrlKey && t.altKey) && (t.ctrlKey || t.metaKey || st)) return !0;
            if (u) {
                ...
                var k = nt && !h ? f.end : f.begin,
                    b = C(k, m, n);
                if (b !== !1) {
                    if (b !== !0 && (k = void 0 != b.pos ? b.pos : k, m = void 0 != b.c ? b.c : m), d(!0), void 0 != b.caret) p = b.caret;
                    else {
                ...
                if (a !== !1) {
                    ...
                    } else h && (c().buffer = void 0, c().validPositions = c().undoPositions)
                } else h && (c().buffer = void 0, c().validPositions = c().undoPositions);
        ...
        function Q(t) {
            var i = this,
                ...
                n = i._valueGet(!0),
                r = B(i);
            if ("propertychange" == t.type && i._valueGet().length <= M()) return !0;
            if ("paste" == t.type) {
                var s = n.substr(0, r.begin),
                    l = n.substr(r.end, n.length);
        ...
        function J(t) {
            var i = this,
                a = et || B(i);
            0 == t.originalEvent.data.indexOf(tt) && (d(), a = {
                begin: 0,
                end: 0
            });
        ...
        function Y(t) {
            if (it = e(t), it.is(":input") && i(it.attr("type"))) {
                if (it.data("_inputmask", {
                        ...
                        opts: o,
                        isRTL: !1
                    }), o.showTooltip && it.prop("title", c().mask), ("rtl" == t.dir || o.rightAlign) && it.css("text-align", "right"), "rtl" == t.dir || o.numericInput) {
                ...
                it.unbind(".inputmask"), it.closest("form").bind("submit", function() {
                    ...
                    if (t.is(":focus")) {
                        var a = B(i);
                        if (a.begin == a.end)
                            if (o.radixFocus && "" != o.radixPoint && -1 != e.inArray(o.radixPoint, y()) && (lt || y().join("") == b().join(""))) B(i, e.inArray(o.radixPoint, y())), lt = !1;
                            else {
                                var n = nt ? F(a.begin) : a.begin,
                                    r = A(p(n));
        ...
        if (void 0 != a) switch (a.action) {
            ...
            case "mask":
                ...
                break;
            case "format":
                it = e({}), it.data("_inputmask", {
                    maskset: n,
                    opts: o,
                    isRTL: o.numericInput
                }), o.numericInput && (nt = !0);
                var ut = (e.isFunction(o.onBeforeMask) ? o.onBeforeMask.call(it, a.value, o) || a.value : a.value).split("");
                return T(it, !1, !1, nt ? ut.reverse() : ut), e.isFunction(o.onBeforeWrite) && o.onBeforeWrite.call(this, void 0, y(), 0, o), a.metadata ? {
                    value: nt ? y().slice().reverse().join("") : y().join(""),
                    metadata: it.inputmask("getmetadata")
                } : nt ? y().slice().reverse().join("") : y().join("");
            case "isValid":
                it = e({}), it.data("_inputmask", {
                    maskset: n,
                    opts: o,
            ...
            case "remove":
                ...
                var ft;
                Object.getOwnPropertyDescriptor && (ft = Object.getOwnPropertyDescriptor(vt, "value")), ft && ft.get ? vt._valueGet && Object.defineProperty(vt, "value", {
                    get: vt._valueGet,
                    set: vt._valueSet
                }) : document.__lookupGetter__ && vt.__lookupGetter__("value") && vt._valueGet && (vt.__defineGetter__("value", vt._valueGet), vt.__defineSetter__("value", vt._valueSet));
                try {
    ...
    if (void 0 === e.fn.inputmask) {
        var r = navigator.userAgent,
            s = null !== r.match(new RegExp("iphone", "i")),
            ...
            u = (/Kindle/i.test(r) || /Silk/i.test(r) || /KFTT/i.test(r) || /KFOT/i.test(r) || /KFJWA/i.test(r) || /KFJWI/i.test(r) || /KFSOWI/i.test(r) || /KFTHWA/i.test(r) || /KFTHWI/i.test(r) || /KFAPWA/i.test(r) || /KFAPWI/i.test(r), t("paste") ? "paste" : t("input") ? "input" : "propertychange");
        e.inputmask = {
            defaults: {
                placeholder: "_",
                optionalmarker: {
            ...
            if ("string" == typeof t) switch (t) {
                case "mask":
                    return a(l.alias, i, l), s = n(l), void 0 == s ? this : this.each(function() {
                        o({
                            action: "mask",
                            el: this
                        }, e.extend(!0, {}, s), r(this, l))
                    });
                case "unmaskedvalue":
                    var u = e(this);
                    return u.data("_inputmask") ? o({
                ...
                if ("object" == typeof t) return l = e.extend(!0, {}, e.inputmask.defaults, t), a(l.alias, t, l), s = n(l), void 0 == s ? this : this.each(function() {
                    o({
                        action: "mask",
                        el: this
                    }, e.extend(!0, {}, s), r(this, l))
