		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					...
					<div class="col-md-3">
						<?php
						if (authorize($_SESSION["access"]["manajemen_directory"]["directory"]["ac_create"])) {
							echo anchor('', '<i class="fa fa-plus"></i> Buat Berkas Baru', 'class="btn btn-primary btn-block margin-bottom" data-toggle="modal" data-target="#tgldirectory_modal"');
						}
						?>
						...
						<div class="modal fade" id="tgldirectory_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<?= form_open_multipart('backoffice/directory/form', 'id="demo-form" data-parsley-validate data-validate'); ?>
		...
		<script>
			$(document).ready(function() {
				...
				var dataTable = $('#example2').DataTable({
					...
					"ordering": false,
					"ajax": {
						url: "<?php echo base_url('backoffice/directory/fetch_ajax'); ?>",
						type: "POST",
					},
					"language": {
				...
				$(document).on('click', '#sbm-tgl', function() {
					...
					if (isValid) {
						swal({
							title: 'Sedang Memproses Direktori...',
							...
							//if direktori count 1, just go to directory with direktori primary key
							// else insert direktori and go to directory with direktori lastinsertID();
							$.ajax({
								method: "POST",
								url: "<?php echo base_url('backoffice/directory/chk_dir'); ?>",
								data: {
									tgl: tgl
								},
						...
						if (chk.length > 0) {
							...
							swal({
								...
								function() {
									$.ajax({
										method: "POST",
										url: "<?php echo base_url('backoffice/directory/multi_delete'); ?>",
										data: {
											chk_val: chk_val
										},
										success: function(msg) {
